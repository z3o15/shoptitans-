...
# 导入路径管理器
try:
    from src.utils.path_manager import get_path_manager, PathManager
except ImportError:
...
class ConfigManager:
    ...
    def __init__(self, config_path: str = "config.json"):
        ...
        # 初始化路径管理器
        self.path_manager = get_path_manager(self)
    ...
    def get_path(self, path_key: str, create_if_not_exists: bool = False) -> str:
        ...
        Returns:
            路径字符串
        """
        return self.path_manager.get_path(path_key, create_if_not_exists)
    ...
    def join_path(self, base_key: str, *path_parts: str, create_if_not_exists: bool = False) -> str:
        ...
        Returns:
            连接后的路径
        """
        return self.path_manager.join_path(base_key, *path_parts, create_if_not_exists=create_if_not_exists)
    ...
    def get_timestamp_dir(self, base_key: str, timestamp: str = None, create_if_not_exists: bool = True) -> str:
        ...
        Returns:
            时间戳目录路径
        """
        return self.path_manager.get_timestamp_dir(base_key, timestamp, create_if_not_exists)
    ...
    def get_latest_timestamp_dir(self, base_key: str) -> Optional[str]:
        ...
        """
        return self.path_manager.get_latest_timestamp_dir(base_key)
    ...
    def find_file_by_extensions(self, base_key: str, filename: str, extensions: List[str] = None) -> Optional[str]:
        ...
        """
        return self.path_manager.find_file_by_extensions(base_key, filename, extensions)
    ...
    def validate_path(self, path_key: str) -> Dict[str, Any]:
        ...
        Returns:
            验证结果字典
        """
        return self.path_manager.validate_path(path_key)
    ...
    def ensure_path_valid(self, path_key: str, create_if_missing: bool = True) -> bool:
        ...
        Returns:
            路径是否有效或创建成功
        """
        return self.path_manager.ensure_path_valid(path_key, create_if_missing)
    ...
    def validate_all_paths(self) -> Dict[str, Dict[str, Any]]:
        ...
        Returns:
            所有路径的验证结果字典
        """
        return self.path_manager.validate_all_paths()
    ...
    def get_path_validation_report(self) -> str:
        ...
        Returns:
            格式化的验证报告字符串
        """
        return self.path_manager.get_path_validation_report()
