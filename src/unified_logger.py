...
class UnifiedLogger:
    ...
    def __init__(self, base_output_dir: str = "output", console_mode: bool = True):
        ...
        self.output_config = {
            ...
            "console_level": "INFO"          # 控制台日志级别：只显示INFO及以上级别
        }
    ...
    def log_info(self, message: str, step_id: Optional[str] = None,
        ...
        if show_in_console is None:
            ...
            show_in_console = self.output_config["console_level"] in ["DEBUG", "INFO"]
    ...
    def log_success(self, message: str, step_id: Optional[str] = None, 
        ...
        """
        if show_in_console is None:
            show_in_console = self.output_config["show_success_summary"]
