...
from ..config.config_manager import get_config_manager, create_recognizer_from_config

# 导入统一日志管理器
try:
    from ..logging.unified_logger import get_unified_logger
...
"""
    ...
    def process_screenshot(self, screenshot_path, base_img_path, output_folder, 
        ...
        # 创建输出文件夹
        crop_folder = os.path.join(output_folder, "cropped_equipment")
...
def main():
    ...
    SCREENSHOT_NAME = "MuMu-20251122-201210-068.png"  # 待处理的游戏截图文件名
