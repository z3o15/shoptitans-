...
from src.preprocessing.resizer import ImageResizer
from src.config.config_manager import get_config_manager
from src.preprocessing.base_equipment_preprocessor import BaseEquipmentPreprocessor
...
class FeatureCacheManager:
    ...
    def get_cached_features(self, equipment_name):
        ...
        # 尝试多种可能的文件名
        standard_extensions = ['.webp', '.png', '.jpg', '.jpeg', '.bmp', '.tiff']
        possible_names = [f"{equipment_name}{ext}" for ext in standard_extensions]
